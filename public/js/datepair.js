...
(function(window, document) {
	...
	Datepair.prototype = {
		...
		getTimeRange: function() {
			var from;
			var to;
			if (this.startDateInput && this.startDateInput.value && this.startTimeInput && this.startTimeInput.value) {
				...
				from = startDate.getTime() + startTime.getTime();
			}
			if ( this.endDateInput && this.endDateInput.value && this.endTimeInput && this.endTimeInput.value) {
				var endDate = this.settings.parseDate(this.endDateInput);
				var endTime = this.settings.parseTime(this.endTimeInput);
				endTime.setFullYear(1970)
				endTime.setMonth(0)
				endTime.setDate(1)
				to = endDate.getTime() + endTime.getTime();
			}
			return {
				from: from,
				to: to
